...
import { TiSocialInstagram, TiSocialTwitter, TiSocialYoutube, TiSocialFacebook } from "react-icons/ti";
...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "Facebook", icon: TiSocialFacebook, href: "https://facebook.com", color: "hover:bg-[#FF0000]" },
  ];
